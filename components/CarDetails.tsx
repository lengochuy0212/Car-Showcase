...
const CarDetails = ({ isOpen,closedModal,car}: CarDetailsProps) => {
  return (
    <>
    <Transition appear show={isOpen} as={Fragment}>
        <Dialog as='div' className="relative z-10" onClose={closedModal}>
            <Transition.Child
             as={Fragment}
            ...
            <div className='fixed inset-0 overflow-y-auto'>
             ...
             leaveTo='opacity-0 scale-95'>
                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2x1 bg-white p-6 text-left shadow-xsl transition-all flex flex-col gap-5">
                    <button type="button"
